...
import { ArrowRight, Sparkles, Compass, CheckCircle2, ShieldCheck, BellRing } from "lucide-react";
    ...
    <section className="relative overflow-hidden py-16 sm:py-24 lg:py-32">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 mb-8">
          <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-slate-900/90 border border-slate-800 shadow-xl backdrop-blur-md">
            ...
            <span className="text-xs font-semibold text-slate-200">
              Google Developer Groups · Recruitments 2026
            </span>
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-[1.12]">
          Build for the Future. <br className="hidden sm:inline" />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#4285F4] via-[#60A5FA] to-[#0F9D58]">
            Join Google Developer Groups.
          </span>
        </h1>

        {/* Subtitle */}
        <p className="mt-6 text-base sm:text-lg lg:text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed">
          Collaborate on production software, web3 systems, AI models, and modern UX design. Click below to explore all 8 technical departments and submit your application.
        </p>
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link href="/departments" className="w-full sm:w-auto">
            <Button
              size="lg"
              className="w-full sm:w-auto bg-blue-600 hover:bg-blue-500 text-white font-semibold px-8 h-12 rounded-xl shadow-lg shadow-blue-900/40 gap-2 transition-all active:scale-[0.98]"
            >
          ...
          {!user ? (
            <Link href="/auth/signin" className="w-full sm:w-auto">
              <Button
                size="lg"
                variant="outline"
                className="w-full sm:w-auto border-slate-800 bg-slate-900/80 hover:bg-slate-800 text-slate-200 h-12 px-7 rounded-xl backdrop-blur-md transition-all gap-2"
              >
            ...
            <Link href="/passport" className="w-full sm:w-auto">
              <Button
                size="lg"
                variant="outline"
                className="w-full sm:w-auto border-emerald-800/80 bg-emerald-950/40 hover:bg-emerald-900/40 text-emerald-300 h-12 px-7 rounded-xl backdrop-blur-md transition-all gap-2"
              >
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-5 text-left border-t border-slate-800/80 pt-10">
          <div className="flex items-start gap-3.5 p-5 rounded-2xl bg-slate-900/50 border border-slate-800/70 backdrop-blur-sm hover:border-slate-700 transition-colors">
            ...
            <div>
              <h2 className="text-sm font-bold text-slate-100">1. Select 2 Domains</h2>
              <p className="text-xs text-slate-400 mt-1.5 leading-relaxed">
                Click Choose Departments to view and select up to 2 technical domains.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3.5 p-5 rounded-2xl bg-slate-900/50 border border-slate-800/70 backdrop-blur-sm hover:border-slate-700 transition-colors">
            ...
            <div>
              <h2 className="text-sm font-bold text-slate-100">2. Guided Form</h2>
              <p className="text-xs text-slate-400 mt-1.5 leading-relaxed">
                Step-by-step technical questionnaire with live autosave and review.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3.5 p-5 rounded-2xl bg-slate-900/50 border border-slate-800/70 backdrop-blur-sm hover:border-slate-700 transition-colors">
            ...
            <div>
              <h2 className="text-sm font-bold text-slate-100">3. Application Passport</h2>
              <p className="text-xs text-slate-400 mt-1.5 leading-relaxed">
                Get an official Application Passport with cryptographic QR verification.
              </p>
            </div>
          </div>
        </div>
