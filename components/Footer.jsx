...
const Footer = () => {
  return (
    <footer className="w-full border-t border-slate-800/80 bg-slate-950/60 backdrop-blur-md py-10 mt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        <div className="flex flex-col gap-2">
          <GDGLogo subtitle="Recruitment Portal System" size="sm" />
          <p className="text-xs text-slate-500 max-w-md">
            Official recruitment platform for Google Developer Groups (GDG) technical departments. Built with engineering excellence.
          </p>
          <span className="text-[11px] text-slate-500">&copy; {currentYear} Google Developer Groups. All rights reserved.</span>
        </div>
