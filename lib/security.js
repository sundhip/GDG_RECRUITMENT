...
/**
 * Validate college registration number format (e.g. 25BCE5612).
 * @param {string} regNo
 * @returns {boolean}
 */
...
export function validateSubmissionInput(rawBody, verifiedSessionEmail) {
  ...
  if (!validateRegistrationNumber(regNo)) {
    errors.push("Registration number must be 2 digits, 3 uppercase letters, and 4 digits (e.g. 25BCE5612)");
  }
...
export function validateShortlistInput(rawBody) {
  ...
  return { valid: true, shortlisted: isShortlisted, errors: [] };
}
